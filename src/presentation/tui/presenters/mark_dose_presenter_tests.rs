#[cfg(test)]
mod tests {
    use super::super::mark_dose_presenter::build_mark_dose_lines;
    ...
    fn headers_are_styled_and_grouped() {
        ...
        let lines = build_mark_dose_lines(&[rec1, rec2], 0);
        // expect Registered records header as styled span first
        assert!(matches!(lines[0], Line::From(_)|Line::from(Span::Styled{..}) ));
        // compare constructed header directly
