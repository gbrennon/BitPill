    ...
    match &app.current_screen {
        ...
        Screen::CreateMedication {
            ...
            &CreateMedicationPresenterDto {
                ...
                frequency_options: &["Once Daily", "Twice Daily", "Thrice Daily", "Custom"],
        ...
        Screen::EditMedication {
            ...
            // Use a dedicated UpdateMedicationPresenter for edit screens so titles are injected
            use crate::presentation::tui::presenters::update_medication_presenter::{UpdateMedicationPresenter, UpdateMedicationPresenterDto};
        ...
        Screen::ConfirmCancel { previous: _ } => {
            let title = "Discard Changes";
            let content = &"Discard changes and return?  (y/N)";
            render_modal(f, f.area(), title, content);
        }
