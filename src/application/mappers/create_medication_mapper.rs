...
/// Adapts `CreateMedicationRequest` to a domain `Medication`.
///
/// Parses request fields, validates them using domain value objects,
/// and constructs a domain `Medication`.
